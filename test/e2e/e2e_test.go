...
import (
	...
	"github.com/dioniseo/kubernetes-pg-manager-operator/test/utils"
)

// namespace where the project is deployed in
const namespace = "kubernetes-pg-manager-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "kubernetes-pg-manager-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "kubernetes-pg-manager-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "kubernetes-pg-manager-operator-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=kubernetes-pg-manager-operator-metrics-reader",
