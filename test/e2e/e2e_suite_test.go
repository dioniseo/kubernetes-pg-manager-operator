...
var (
	...
	projectImage = "example.com/kubernetes-pg-manager-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting kubernetes-pg-manager-operator integration test suite\n")
